...
<body>
    ...
    <div id="site">
        ...
        ?>
        <h1> Bem vindo ao Jogo NIM! </h1>
        <form action="jogo.php" method="get">
            <input type="number" name="pecas" placeholder="Número total de peças no jogo">  Escolha <br><br>
            <input type="number" name="limite" placeholder="Número limite de peças por jogada">  Escolha<br><br>
            <input type="submit" value="Enviar">
            <?php
             function partida(){
            $n = $_GET['pecas']; #numero total de peças
            $m = $_GET['limite']; #numero maximo por jogada
            if ($n == 2 and $m == 3){
